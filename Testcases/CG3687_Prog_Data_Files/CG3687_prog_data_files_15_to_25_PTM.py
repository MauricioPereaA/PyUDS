...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    def test_006(self, name='Request Download of modified Calibration Data file  (Outer envelope Protected 02 00, Inner envelope Plain 01 01)'):
    ...
    def test_007(self, name='Transfer Data modified Calibration Data file  (Outer envelope Protected 02 00, Inner envelope Plain 01 01)'):
        for packet in Binary.packets_to_send(_binary_app):
            packet_list = list(packet)
            packet_list[4:8] = '0200'
            packet_list[2048:2052] = '0101'
    ...
    def test_008(self, name='Read PEC'):
    ...
    def test_009(self, name= 'Execute retry strategy to restart the programming sequence as applicable'):
        test.preconditions(
            step_info=info()
        )
