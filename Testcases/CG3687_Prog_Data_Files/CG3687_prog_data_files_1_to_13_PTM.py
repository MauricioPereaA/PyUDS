...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    def test_007(self, name='Transfer Data of modified Application SW file'):
        test.preconditions(
            step_info=info()
        )
    ...
    def test_010(self, name= 'Repeat Programming with modified App SW  file Two envelope structure '):
        test.preconditions(
            step_info=info()
        )
