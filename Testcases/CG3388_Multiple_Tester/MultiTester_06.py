...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_013(self, name='Multiple Tester 6'):

        # *CHECKED* - Check-box
        test.canoe.set_envVariable(MultiTester6=1)

        # *PUSH* - Run selected test cases
        test.canoe.set_envVariable(MultiTester=1)
        time.sleep(0.75)
        test.canoe.set_envVariable(MultiTester=0)
        test.canoe.set_envVariable(MultiTester6=0)
        ...
        test.compare(self.MultiTester.test_case_006(), True, 
                        step='test_013')
    def test_014(self, name='Multiple Tester 6'):
        test.compare(self.MultiTester.test_case_006(), True, 
                        step='test_014') 
    def test_015(self, name='Multiple Tester 6'):
        test.compare(self.MultiTester.test_case_006(), True, 
                        step='test_015') 