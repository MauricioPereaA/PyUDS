...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='Transport Layer 23'):

        # *CHECKED* - Check-box
        test.canoe.set_envVariable(TransportLayer23=1)
        ...
        test.canoe.set_envVariable(TransportLayer23=0)

        # Wait for Transport Layer Test Case to be finished
        print('Please wait until TC is completed...')
        time.sleep(10)
        test.canoe.stop()
        test.compare(self.TransportLayer.test_case_23(blocksize = 1), True, 
                        step='test_001') 

    def test_002(self, name='Transport Layer 23'):
        test.compare(self.TransportLayer.test_case_23(blocksize = 8), True, 
                        step='test_002') 

    def test_003(self, name='Transport Layer 23'):
        test.compare(self.TransportLayer.test_case_23(blocksize = 20), True, 
                        step='test_003')
