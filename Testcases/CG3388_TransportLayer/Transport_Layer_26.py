...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='Transport Layer 26'):

        # *CHECKED* - Check-box
        test.canoe.set_envVariable(TransportLayer26=1)
        ...
        test.canoe.set_envVariable(TransportLayer26=0)

        # Wait for Transport Layer Test Case to be finished
        print('Please wait until TC is completed...')
        time.sleep(5)
        test.canoe.stop()
        analysis_results = self.TransportLayer.test_case_26()
