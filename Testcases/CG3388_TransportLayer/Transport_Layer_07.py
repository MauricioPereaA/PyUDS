...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='Transport Layer 7'):

        # *CHECKED* - Check-box
        test.canoe.set_envVariable(TransportLayer7=1)
        ...
        test.canoe.set_envVariable(TransportLayer7=0)

        # Wait for Transport Layer Test Case to be finished
        print('Please wait until TC is completed...')
        time.sleep(5)
        test.canoe.stop()
        test.compare(self.TransportLayer.test_case_07(), True, 
                        step='test_001')      
