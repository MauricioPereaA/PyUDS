...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='Transport Layer 5'):

        # *CHECKED* - Check-box
        test.canoe.set_envVariable(TransportLayer5=1)
        ...
        test.canoe.set_envVariable(TransportLayer5=0)

        # Wait for Transport Layer Test Case to be finished
        print('Please wait until TC is completed...')
        time.sleep(5)
        test.canoe.stop()
        test.compare(self.TransportLayer.test_case_05(), True, 
                        step='test_001') 
