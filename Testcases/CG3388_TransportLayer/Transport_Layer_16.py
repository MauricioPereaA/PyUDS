...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='Transport Layer 16'):
        for _ in range(10):
            test.begin(
                test_info=info(),
            ...
            # *CHECKED* - Check-box
            test.canoe.set_envVariable(TransportLayer16=1)
            ...
            test.canoe.set_envVariable(TransportLayer16=0)
            ## Wait for Transport Layer Test Case to be finished
            print('Please wait until TC is completed...')
            time.sleep(8)
            test.canoe.stop()
            if self.TransportLayer.test_case_16_interruption_correctly():
                test.compare(self.TransportLayer.test_case_16(), True, 
                        step='test_001') 
                self.test_passed = True
                break
            print('Test not accomplished. Reattempting...')
