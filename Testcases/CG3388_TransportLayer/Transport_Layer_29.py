...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='Transport Layer 21'):

        # *CHECKED* - Check-box
        test.canoe.set_envVariable(TransportLayer29=1)
        ...
        test.canoe.set_envVariable(TransportLayer29=0)

        # Wait for Transport Layer Test Case to be finished
        print('Please wait until TC is completed...')
        time.sleep(8)
        test.canoe.stop()
        analysis_results = self.TransportLayer.test_case_29()
