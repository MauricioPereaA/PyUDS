...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='Transport Layer 36'):

        # *CHECKED* - Check-box
        test.canoe.set_envVariable(TransportLayer36=1)
        ...
        test.canoe.set_envVariable(TransportLayer36=0)

        # Wait for Transport Layer Test Case to be finished
        print('Please wait until TC is completed...')
        time.sleep(5)
        test.canoe.stop()
        test.compare(self.TransportLayer.test_case_36(), True, 
                        step='test_001') 
