...
class Comp_Hand(unittest.TestCase):
    ...
    def test_006(self, name='Request Download of Signed Uncompressed App SW file'):
    ...
    def test_007(self, name='Transfer Data of Signed Uncompressed App SW file'):
        test.preconditions(
            step_info=info()
        )
  ...
  # Transition to programmingSession
    ...
    def test_015(self, name='Request Download of Signed Compressed Calibration Data file'):
    ...
    def test_016(self, name='Transfer Data of Data of Uncompressed App SW file'):
        test.preconditions(
            step_info=info()
        )
