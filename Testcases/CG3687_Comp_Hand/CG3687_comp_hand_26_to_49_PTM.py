...
class Gen_Boot_Requirements(unittest.TestCase):
  ...
  # Transition to programmingSession
    ...
    def test_016(self, name='Transfer Data of Signed ARLE Compressed Calibration Data file'):
    ...
    def test_020(self, name='Repeat test, "Flash" Compressed App SW file, Compressed Calibration Data file(s)" for LZMA Compression Method'):
        pass
