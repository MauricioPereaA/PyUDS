...
class Comp_Hand(unittest.TestCase):
    ...
    def test_006(self, name='Request Download of Signed Compressed App SW file'):
  ...
  # Transition to programmingSession
    ...
    def test_015(self, name='Request Download Signed Uncompressed Calibration Data file'):
    ...
    def test_016(self, name='Transfer Data of Signed Uncompressed Calibration Data file'):
