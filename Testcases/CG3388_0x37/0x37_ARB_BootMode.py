...
class Request_Download(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        test.begin(
            ...
            excel_tab='0x37'  # Specify CG Excel Tab
        )
    ...
    def test_008(self, name='Erase Application'):
        input(
    ...
    def test_009(self, name='Request Transfer Exit -- NRC 0x24'):
        test.preconditions(
            step_info=info()
            )
    ...
    #For Test Step 7:
    # Create a condition in which service $36, TransferData, is in process and not complete
    # whenthe request for service $37 is received
    # You can run the ECU programming script and send service 37 during 36
    ...
    #For Test Step 12:
    # Create conditions that Server detects an error when finalizing the data transfer
    # between the client and server>
    # This test needs to be Manual.
