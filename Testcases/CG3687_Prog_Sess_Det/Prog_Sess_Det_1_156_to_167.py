...
class Prog_Sess_Det(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Please ensure you have a Green ECU and ensure that you specify an LZMA compressed binary app with Calculated message digest != Received Message Digest'
