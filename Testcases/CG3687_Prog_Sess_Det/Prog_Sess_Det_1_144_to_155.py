...
class Prog_Sess_Det(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Please ensure you have APP SW Flashed and ensure that you specify an LZMA compressed binary app with Calibration address ranges != range stored in the boot Info block'
