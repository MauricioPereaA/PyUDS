...
class Prog_Sess_Det(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Please ensure you have a Green ECU and ensure that you specify an LZMA compressed binary app exceeding the expected length of data'
    ...
    def test_013(self, name='Observe normal communication message is disabled'):
        time.sleep(2)
        test.preconditions(
            step_info=info()
        )
        test.compare(True, test.normal_comm(), step='test_013')


    def test_014(self, name='Program ECU'):
