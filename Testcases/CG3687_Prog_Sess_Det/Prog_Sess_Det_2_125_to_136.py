...
class Prog_Sess_Det(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Please ensure you have a Green ECU and ensure that you specify an LZMA compressed binary cal1 with Calculated message digest != Received Message Digest'
    ...
    def test_009(self, name='Program ECU'):
