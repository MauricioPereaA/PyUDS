...
class Prog_Sess_Det(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Please ensure you have a Green ECU and ensure that you specify an LZMA compressed binary cal1 with ECU Name != Expected'
    ...
    def test_006(self, name='Request Download Cal File'):
    ...
    def test_007(self, name='Bootloader evaluates Data Type in 1st received envelope'):
        test.preconditions(
            step_info=info()
        )
        ...
        for packet in Binary.packets_to_send(_binary_cal1):
            ...
            packet_list[0:4] = ''    # Pending to add value
