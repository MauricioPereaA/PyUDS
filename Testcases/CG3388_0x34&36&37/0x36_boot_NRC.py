...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_012(self, name='restart Boot Mode'):
        test.preconditions(
            step_info=info(),
            functionalAddr=True
        )
    ...
    def test_014(self, name='Transfer Data of Valid Signed App SW file'):
        time.sleep(0.5)
...
#change binary 0x6F9         
    ...
    def test_018(self, name='Erase Application SW Memory'):
        test.preconditions(
            step_info=info(),
            functionalAddr=True
        )
