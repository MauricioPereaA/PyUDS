...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Please ensure you have APP SW Flashed on the ECU.'+\
                  '\nThis test is intented to Err_MoreDataExpected when programming APP SW with length of programmable file less than expected length'
    ...
    def test_007(self, name='Transfer Data modified App SW file (Bootloader receives more data than allowed)'):
        ...
        for i, packet in enumerate(Binary.packets_to_send(_binary_app)):
            if i == 1:
                ...
                del packet_list[len(packet_list) - 68 : len(packet_list)]
    ...
    def test_009(self, name='Verify PEC'):
