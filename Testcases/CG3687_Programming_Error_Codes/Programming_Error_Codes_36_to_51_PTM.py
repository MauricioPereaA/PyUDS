...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Please ensure you have APP SW Flashed on the ECU.'+\
                  '\nThis test is intented to Err Compression when there is an error decompressing the data stream'
    ...
    def test_006(self, name='Request Download modiified App SW file'):
    ...
    def test_007(self, name='Transfer Data App SW fle with Compressed file structure'):
