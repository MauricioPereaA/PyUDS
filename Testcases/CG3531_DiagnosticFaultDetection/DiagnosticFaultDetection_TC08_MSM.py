...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        if device_under_test not in ['MSM', 'TCP']:
            raise Warning(__name__, 'This test case is only meant to be executed for MSM/TCP')
    ...
    def test_005(self, name='%s :: stop message transmission + read DTC - DTC is Set | '%device_under_test):
    ...
    def test_008(self, name='%s :: Review DTC status byte'%device_under_test):
        test.preconditions(step_info=info())
