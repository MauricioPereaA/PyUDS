...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='All conditions satisfied DID 4314'):
        test.preconditions(
            step_info=info(),
            power_mode='RUN',
            signal = [
    ...
    def test_002(self, name='Condition 1 not satisfied DID 4314'):
        test.preconditions(
            step_info=info(),
            signal = [
    ...
    def test_003(self, name='Condition 2 not satisfied DID 4314'):
        test.preconditions(
            step_info=info(),
            signal = [
                        'VSADP_VehSpdAvgDrvnAuth', 'VehSpdAvgDrvn_Prtctd_PDU', 0,
    ...
    def test_004(self, name='Condition 3 not satisfied DID 4314'):
        test.preconditions(
            step_info=info(),
            signal = [
                        'VSADP_VehSpdAvgDrvnAuth', 'VehSpdAvgDrvn_Prtctd_PDU', 0,
