...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='All conditions satisfied RID 0205'):
        test.preconditions(
            step_info=info(),
            signal = [
    ...
    def test_002(self, name='Condition 1 not satisfied RID 0205'):
        test.preconditions(
            step_info=info(),
            signal = [
    ...
    def test_003(self, name='Condition 2 not satisfied RID 0205'):
        test.preconditions(
            step_info=info(),
            signal = [
                        'PSP_PrplSysActvAuth', 'PrplStat_Prtctd_PDU', 0,
    ...
    def test_004(self, name='Condition 3 not satisfied RID 0205'):
        test.preconditions(
            step_info=info(),
            signal = [
                        'PSP_PrplSysActvAuth', 'PrplStat_Prtctd_PDU', 0,
