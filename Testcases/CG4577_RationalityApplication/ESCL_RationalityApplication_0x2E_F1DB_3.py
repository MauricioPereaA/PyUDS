...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_002(self, name='Request Remote Diagnostics seed security access'):
        test.preconditions(
            step_info=info()         
        )
    ...
    def test_004(self, name='Condition 1 satisfied DID F1 DB'):        
        test.preconditions(
            step_info=info(),       
        )
        ...
        test.step(
            step_title=name,
            custom='2E F1 DB 42 56',
            expected={
               'response': 'Positive'
            }
        )
    
    def test_005(self, name='Condition 1 not satisfied DID F1 DB'):        
        test.preconditions(
            step_info=info(),
            mec_zero=True         
        )
