...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_001(self, name='All conditions satisfied DID 4B5D'):
        test.preconditions(
            step_info=info(),
            power_mode='RUN',
            signal = [
        ...
        test.step(
            step_title=name,
            custom='2F 4B 5D 03 00',
            expected={
                'response': 'Positive'
            }
        )     
        
    def test_002(self, name='Condition 1 not satisfied DID 4B5D'):
        test.preconditions(
            step_info=info(),
            signal = [
    ...
    def test_003(self, name='Condition 2 not satisfied DID 4B5D'):
        test.preconditions(
            step_info=info(),
            signal = [
                        'VSADP_VehSpdAvgDrvnAuth', 'VehSpdAvgDrvn_Prtctd_PDU', 0,
    ...
    def test_004(self, name='Condition 3 not satisfied DID 4B5D'):
    ...
    def test_005(self, name='Condition 4 not satisfied DID 4B5D'):
