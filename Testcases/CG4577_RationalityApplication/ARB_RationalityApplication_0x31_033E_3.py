...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_003(self, name='All conditions satisfied RID 033E'):
        test.preconditions(
            step_info=info(),
            signal = [
    ...
    def test_004(self, name='Condition 1 not satisfied RID 033E'):
        test.preconditions(
            step_info=info(),
            signal = [
    ...
    def test_005(self, name='Condition 2 not satisfied RID 033E'):
        test.preconditions(
            step_info=info(),
            signal = [
                        'VSADP_VehSpdAvgDrvnAuth', 'VehSpdAvgDrvn_Prtctd_PDU', 0,
