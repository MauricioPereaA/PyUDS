...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_003(self, name='All conditions satisfied DID 4B5D'):
        test.preconditions(
            step_info=info(),
            power_mode='RUN',
            signal = [
    ...
    def test_004(self, name='Condition 1 not satisfied DID 4B5D'):
        test.preconditions(
            step_info=info(),
            signal = [
    ...
    def test_005(self, name='Condition 2 not satisfied DID 4B5D'):
        test.preconditions(
            step_info=info(),
            signal = [
                        'VSADP_VehSpdAvgDrvnAuth', 'VehSpdAvgDrvn_Prtctd_PDU', 0,
    ...
    def test_006(self, name='Condition 3 not satisfied DID 4B5D'):
    ...
    def test_007(self, name='Condition 4 not satisfied DID 4B5D'):
