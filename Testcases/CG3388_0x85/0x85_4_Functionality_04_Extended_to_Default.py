...
#         self.DTC = pn_dict[device_under_test]['protected_messages'][self.protected_message]['DTC']
    ...
    def test_038(self, name='extendedSession'):
        test.preconditions(
            step_info=info(),
            power_mode='RUN'
        )
    ...
    def test_039(self, name='tester present'):
        test.preconditions(
            step_info=info(),
            functionalAddr=True
        )
    ...
    def test_040(self, name='Clear DTCs'):
        test.preconditions(
            step_info=info(),
            functionalAddr=True,
    ...
    def test_042(self, name='Read DTCs'):
        time.sleep(1)
        test.preconditions(
            step_info=info(),
    ...
    def test_043(self, name='Disable DTCs'):
        test.preconditions(
            step_info=info()
        )
        test.step(
    ...
    def test_045(self, name='Create failure conditions - DTC should not be set'):
        test.preconditions(
            step_info=info()
        )
        # Set DTC Conditions
        test.canoe.set_envVariable(**dict({self.protected_message:1}))
        tools.timer.input('Wait for ', timeout=2) #time.sleep(6)
    ...
    def test_046(self, name='transition from Extended to Default'):
        test.preconditions(
            step_info=info()
        )
        test.step(
    ...
    def test_047(self, name='Verify DTC is set'):#not set-->set
        test.preconditions(
            step_info=info()
        )
        test.step(
