...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    def test_007(self, name='Transfer Data of app SW'):
        ...
        message = 'please disconnect the ECU communication cables and then press enter..'
    ...
    def test_008(self, name='Transition to defaultSession, Boot Mode'):
    ...
    def test_024(self, name='Transfer Data'):
        test.preconditions(
            step_info=info()
        )  
        for packet in Binary.packets_to_send(_binary_cal1, percentage = 50):
            test.step(
                step_title=name,
                custom = packet,
                expected={
    ...
    def test_025(self, name='Transition to defaultSession, Boot Mode'):
        message = 'please connect the ECU communication cables and then press enter..'
        tools.popup.warning(title='Bootloader',
                                description=message)
        test.preconditions(
    ...
    def test_027(self, name='Re-start the programming process'):
    ...
    def test_028(self, name='Request Seed'):
    ...
    def test_031(self, name='Request Download of Calibration Data'):
    ...
    def test_034(self, name='Update PSI'):
