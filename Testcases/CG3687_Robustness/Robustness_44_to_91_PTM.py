...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        message = 'Make sure you have a product intent SW.'
    ...
    def test_006(self, name='Request Download of of App SW'):
    ...
    def test_007(self, name='Transfer data of  App SW'):
        test.preconditions(
            step_info=info()
        )
        for packet in Binary.packets_to_send(_binary_app, percentage = 1):
            test.step(
                step_title=name,
                custom = packet,
                expected={
        ...
        for i, packet in enumerate(Binary.packets_to_send(_binary_app)):
            test.step(
                step_title=name,
                custom = packet,
                expected={
    ...
    def test_008(self, name='Re-connect ECU Power'):
        test.power_supply.output(True)
        test.preconditions(
            step_info=info()
        )
        if test.read_power_supply_voltage() >= 9 and test.read_power_supply_voltage() < 16:
            test.compare(True, self.power, step='test_008')
        else:
            test.compare(True, self.no_power, step='test_008')
    ...
    def test_010(self, name='Re-start the programming process'):
    ...
    def test_011(self, name='Request Seed'):
    ...
    # Verify PSI" 
    def test_018(self, name='Read PSI'):
    ...
    # Verify Application SW partition  PSI value is set to "Valid Programming Present" 
      
    # Verify that the PEC is set to "$0000 = Err_NoError"                                     
    def test_019(self, name='Read PEC'):
    ...
    def test_020(self, name='defaultSession '):
    ...
    def test_023(self, name='Transition to programmingSession'):
    ...
    def test_025(self, name='Request Download'):
    ...
    def test_026(self, name='Transfer Data'):
        test.preconditions(
            step_info=info()
        )
    ...
    # Re-connect ECU power
    def test_027(self, name='Re-connect ECU Power'):
        test.power_supply.output(True)
        test.preconditions(
            step_info=info()
        )
        if test.read_power_supply_voltage() >= 9 and test.read_power_supply_voltage() < 16:
            test.compare(True, self.power, step='test_027')
        else:
            test.compare(True, self.no_power, step='test_027')
    ...
    def test_029(self, name='Implement Pre-Programming Sequence'):
    ...
    def test_033(self, name='Request Download of Valid Signed Calibration Data file'):
    ...
    #Verify Application SW partition and Calibration Data partition ID 02 PSI values are set to "Valid Programming Present"


    # Verify that the PEC is set to "$0000 = Err_NoError"
    def test_037(self, name='Read PEC'):
