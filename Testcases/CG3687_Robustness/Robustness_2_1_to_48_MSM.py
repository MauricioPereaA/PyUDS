...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    # Decrease voltage to below ECUs low voltage threshold
    ...
    def test_023(self, name='Request Download of Valid Signed Calibration Data file'):
        ...
        # Decrease voltage to below ECUs low voltage threshold
    def test_024(self, name='Transfer Data of Valid Signed Calibration Data file'):
        test.set_dtc_condition(underVoltage=True)
        test.preconditions(
            step_info=info()
        )
    ...
    # Wait 1 minute then Set the Voltage to Normal Operating Range (=12.5 V)
...
# Verify Application SW partition PSI value is set to "Valid Programming Present" and Calibration Data partition ID 02 PSI value is NOT set to  "Valid Programming Present" 
    ...
    def test_026(self, name='Re-start the programming process'):
    ...
    def test_027(self, name='Request Seed'):
    ...
    def test_028(self, name='Transition to programmingSession'):
    ...
    def test_029(self, name='Erase Memory'):
    ...
    def test_030(self, name='Request Download of Calibration Data'):
    ...
    def test_031(self, name='Transfer Data of Valid Signed Calibration Data file'):
    ...
    def test_032(self, name='Request Transfer Exit'):
    ...
    def test_033(self, name='Update PSI'):
    ...
    def test_035(self, name='Read PEC'):
    ...
    def test_036(self, name='defaultSession '):
