...
class Gen_Boot_Requirements(unittest.TestCase):
  ...
  # defaultSession - Security Level 0D
    ...
    def test_024(self, name='Update PSI'):
    ...
    def test_025(self, name='Read PSI'):
    ...
    # Verify that the PEC is set to "$0000 = Err_NoError"
    def test_026(self, name='Read PEC'):
    ...
    def test_027(self, name='defaultSession '):
    ...
    def test_029(self, name='Request a Download'):
        ...
        test.step(
            step_title=name,
            custom= '34 00 44 00 00 00 00 00 00 1E 00',
