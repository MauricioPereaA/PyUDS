...
class Gen_Boot_Requirements(unittest.TestCase):
    ...
    def test_002(self, name='Verify Application Mode'):
        ...
        test.step(
            step_title=name,
            #custom='34 00 44 00 00 C0 00 00 00 3E 00',   This is the good one
            custom='22 F0 F0',
            expected={
                'response'   : 'Negative',
                'data'       :  '7F'
   ...
   #Program Application SW and Calibration Data to successful completion
    def test_009(self, name='Program Application SW and Calibration Data to successful completion'):
        time.sleep(0.5)
        test.preconditions(
            step_info=info()
        )
