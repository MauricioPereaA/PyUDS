...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_004(self, name='read PDID mode 01 - ADD DELAY 10s'):
        ...
        test.step(
            ...
            read_periodic_data_id=dict(
                DDDID='FF DF', rate='01', timeout=10),#DDDID='FF FA'-->DDDID='FF' re-try it
    ...
    def test_006(self, name='While Server is in extended Session, Send a valid 29 bit Normal fixed addressing, N_TAtype=physical addres request, ADD DELAY 10s'):
        test.preconditions(
            step_info=info()
        )
        test.step(
    ...
    def test_007(self, name='Verify response'):
        ...
        test.compare(True, 
                tools.popup.ask(title=__name__,
                    description='\n ** Please Verify proper response timing between \
                        periodic transmission is sendAtSlowRate (+/- 10%)**\n'),
                    step='test_007'
            )
...
#            custom= '2A 04', #delete
    ...
    def test_010(self, name='Verify response'):
        test.preconditions(
            step_info=info()
        )
        test.compare(True, 
    ...
    def test_011(self, name='stop transmission of PDID FE'):
        test.preconditions(
            step_info=info()
        )
        test.step(
            step_title=name,
            stop_periodic_data='FF',  #FE-->FF
#            custom= '2A 04',#delete
        ...
        test.compare(True, 
                tools.popup.ask(title=__name__,
                    description='\n **  Verify that the periodic response is no longer transmitted on the bus'),
                    step='test_011'
            )
    ...
    """	
    def test_013(self, name='Verify Response'):
        test.preconditions(
            step_info=info()
        )
    ...
    """
    def test_013(self, name='Verify response'):   #change
        test.preconditions(
            step_info=info()
        )
        test.compare(True, 
                tools.popup.ask(title=__name__,
                    description='\n ** Please Verify proper response timing between \
                        periodic transmission is sendAtFastRate (+/- 10%)**\n'),
                    step='test_013'
            )  
			
    def test_014(self, name='stop transmission of PDID FD'):
        test.preconditions(
            step_info=info()
        )
        test.step(
    ...
    def test_016(self, name='Stop tester present'):
        ...
        test.compare(True, 
            tools.popup.ask(title=__name__,
                description='Please verify that the 2A response is not transmitted \
                    periodically on the bus anymore'),
                step='test_016'
        )
    ...
    def test_019(self, name='While Server is in ExtendedSession, Send a valid 29 bitNormal fixed addressing, N_TAtype=physical address request with maximum number of valid periodicDataIdentifieres allowed in a single request- ADD DELAY 120s'):
        test.preconditions(
            step_info=info()
        )
        test.step(
    ...
    def test_020(self, name='Keep periodic scheduler active for 2 minutes'):
        ...
        tools.timer.input('<Keep periodic scheduler active for 120 seconds>', timeout=120)
        test.compare(True, 
            tools.popup.ask(title=__name__,
                description='Please verify that the 2A response is being transmitted \
                    periodically on the bus at the corresponding rate'),
                step='test_020'
        )
    ...
    def test_025(self, name='Keep periodic scheduler active for 2 minutes'):
        ...
        test.compare(True, 
            tools.popup.ask(title=__name__,
                description='\n ** Please verify that the PDIDs of the previous steps are \
    ...
    def test_034(self, name='stop transmission of PDID FF'):
        ...
        test.compare(True, 
            tools.popup.ask(title=__name__,
                description='Verify that requested periodicDataIdentifier stopped and that the periodicDataIdentifier which was not requested continued to be sent'),
                step='test_034'
        )
    ...
    def test_038(self, name='read PDID mode 01'):
        ...
        test.compare(True, 
            tools.popup.ask(title=__name__,
                description='Verify proper responses and response timing between periodic transmission is around 1second'),
                step='test_038'
        )
    ...
    def test_044(self, name='While Server is in extendedSession Send a valid 29 bit Normal fixed addresing,N_TAtype=physical address request-FE'):
        test.preconditions(
            step_info=info()
        )
        test.step(
    ...
    def test_047(self, name='<Verify all scheduled PIDs are stoped>'):
        test.compare(True, 
            tools.popup.ask(title=__name__,
                description='Verify periodic transmission of data records has stopped'),
                step='test_047'
        )
