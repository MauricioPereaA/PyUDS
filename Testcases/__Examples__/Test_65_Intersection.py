    ...
    def test_004(self, name='Start DDDIDs Mode 02 -Expected Passed'):
        ...
        test.step(
            ...
            read_periodic_data_id=dict(
                DDDID='F0 F1 F2 F3 F4 F5 F6 F7', rate='02', timeout=8),
        ...
        test.step(
            step_title=name,
            stop_periodic_data='F0 F1 F2 F3 F4 F5 F6 F7',
        ...
        test.step(
            step_title=name,
            read_periodic_data_id=dict(
                DDDID='F3 F1', rate='01', timeout=6),
            expected={
                'response': 'Positive',
                'periodic_verifications': ({'dddid': 'F3', 'rate': '01', 'tolerance': 10.0}, {'dddid': 'F1', 'rate': '01', 'tolerance': 10.0}),
            }
        )
