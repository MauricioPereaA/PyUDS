...
class PyUDS_TestCase(unittest.TestCase):
    ...
    def test_004(self, name='Start DDDIDs Mode 02 -Expected Passed'):
        ...
        test.step(
            step_title=name,
            read_periodic_data_id=dict(
                DDDID='F5 F6 F9 FA F8', rate='01', timeout=14),

            expected={
                'response': 'Positive',
                'periodic_verifications': (
                {'dddid': 'F5', 'rate': '01', 'tolerance': 10.0}, {'dddid': 'F6', 'rate': '01', 'tolerance': 10.0},
                {'dddid': 'F9', 'rate': '01', 'tolerance': 10.0}, {'dddid': 'F8', 'rate': '01', 'tolerance': 10.0},
                {'dddid': 'FA', 'rate': '01', 'tolerance': 10.0})
            }
        )
        ...
        test.step(
            step_title=name,
            read_periodic_data_id=dict(
                DDDID='F2 F3 F7 FB FC', rate='03', timeout=15),

            expected={
                'response': 'Positive',
                'periodic_verifications': (
                {'dddid': 'F2', 'rate': '03', 'tolerance': 10.0}, {'dddid': 'F3', 'rate': '03', 'tolerance': 10.0},
                {'dddid': 'F7', 'rate': '03', 'tolerance': 10.0}, {'dddid': 'FB', 'rate': '03', 'tolerance': 10.0},
                {'dddid': 'FC', 'rate': '03', 'tolerance': 10.0})
            }
        )

        test.step(
            step_title=name,
            stop_periodic_data='F4 F2 F0',
