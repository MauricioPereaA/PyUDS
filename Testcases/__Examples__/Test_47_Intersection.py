    ...
    def test_004(self, name='Start DDDIDs Mode 02 -Expected Passed'):
        ...
        test.step(
            ...
            read_periodic_data_id=dict(
                DDDID='F0 F1 F2 F3 F4 F5 F6 F7 F8 F9 FA FB FC FD FE FF', rate='02', timeout=8),
            ...
            expected={
                ...
                {'dddid': 'F4', 'rate': '02', 'tolerance': 10.0}, {'dddid': 'F5', 'rate': '02', 'tolerance': 10.0},
                {'dddid': 'F6', 'rate': '02', 'tolerance': 10.0}, {'dddid': 'F7', 'rate': '02', 'tolerance': 10.0},
                {'dddid': 'F8', 'rate': '02', 'tolerance': 10.0}, {'dddid': 'F9', 'rate': '02', 'tolerance': 10.0},
                {'dddid': 'FA', 'rate': '02', 'tolerance': 10.0}, {'dddid': 'FB', 'rate': '02', 'tolerance': 10.0},
                {'dddid': 'FC', 'rate': '02', 'tolerance': 10.0}, {'dddid': 'FD', 'rate': '02', 'tolerance': 10.0},
                {'dddid': 'FE', 'rate': '02', 'tolerance': 10.0}, {'dddid': 'FF', 'rate': '02', 'tolerance': 10.0})
            }
        )

        test.step(
            step_title=name,
            stop_periodic_data='F0 F1 F1',
        ...
        test.step(
            step_title=name,
            read_periodic_data_id=dict(
                DDDID='F0 F1', rate='01', timeout=6),
            expected={
                'response': 'Positive',
                'periodic_verifications': ({'dddid': 'F0', 'rate': '01', 'tolerance': 10.0}, {'dddid': 'F1', 'rate': '01', 'tolerance': 10.0}),
            }
        )
