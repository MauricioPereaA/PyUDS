...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *sbat=False
    *functionalAddr=True for test 4
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F086 ECU Operating State
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read ECU Operating State'):
    ...
    def test_005(self, name='Read ECU Operating State'):
