...
class Test_CorpCommon_DIDs(unittest.TestCase):
    ...
    *****************************************************************************
    ...
    def test_001(self, name='Read Remote Reflash Programming Status'):
    ...
    def test_004(self, name='Read Remote Reflash Programming Status'):
    ...
    def test_010(self, name='Read Remote Reflash Programming Status'):
