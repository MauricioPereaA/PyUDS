...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *Step 3/7: Warning for MSM/ARB/PTM and "Data: '00'" instead of none.
    *sbat=False
    *functionalAddr=True for test 5

Changes for v. 2022 from uif01834 (Abraham Estrada):
    * Test steps according to new version"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F084 Message Authentication Anti Replay Counters
    *****************************************************************************
    '''
    ...
    def test_003(self, name='Read Message Authentication Anti Replay Counters'):
    ...
    def test_005(self, name='Activate Tester present'):
    ...
    def test_006(self, name='Read Message Authentication Anti Replay Counter'):
    ...
    def test_007(self, name='ECU does not support Message Authentication'):
    ...
    def test_008(self, name='Read Message Authentication Anti Replay Counters'):
        if (device_under_test == 'MSM' or device_under_test == 'PTM' or device_under_test == 'ARB'):
            pass
