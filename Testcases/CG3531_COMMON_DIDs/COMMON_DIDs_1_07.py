...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F087 Logistics Mode Status
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Logistics Mode Status'):
        ...
        test.step(
            ...
            expected={
                'response'   : 'Positive',
                'data'       :  None, #Range should be 0x00 thru 0x03
    ...
    def test_005(self, name='Read Logistics Mode Status'):
