...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F1CC GM Base Model Part Number
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read GM Base Model Part Number'):
    ...
    def test_005(self, name='Read GM Base Model Part Number'):
    ...
    def test_011(self, name='Read GM Base Model Part Number'):
        if (device_under_test == 'MSM' or device_under_test == 'PTM' or device_under_test == 'ARB'):
            raise Warning('ECU does not support GB6005. Test step will skip.')
            pass
    ...
    def test_013(self, name='Read GM Base Model Part Number'):
