...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *MSM/PTM/ARB skip tests 10, 11. PTM/ARB skip 12, 13.
    *Deleted steps past 13 (not in 2019 version of CG)
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F182 Application Data Identification Data Identifier
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Application Data Identification Data Identifier'):
    ...
    def test_005(self, name='Read Application Data Identification Data Identifier'):
    ...
    def test_011(self, name='Read Application Data Identification Data Identifier'):
        if (device_under_test == 'MSM' or device_under_test == 'PTM' or device_under_test == 'ARB'):
            raise Warning('ECU does not support GB6005. Test step will skip.')
            pass
    ...
    def test_013(self, name='Read Application Data Identification Data Identifier'):
