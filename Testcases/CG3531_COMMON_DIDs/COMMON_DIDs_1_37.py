...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0FA File Update Identification Data tIdentifier (FUIDI)
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read File Update Identification Data tIdentifier (FUIDI)'):
    ...
    def test_005(self, name='Read File Update Identification Data tIdentifier (FUIDI)'):
    ...
    def test_011(self, name='Read File Update Identification Data tIdentifier (FUIDI)'):
