...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F08D Remote Partial Network Activation Status
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Remote Partial Network Activation Status'):
    ...
    def test_005(self, name='Read Remote Partial Network Activation Status'):
