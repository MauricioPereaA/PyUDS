...
Changes for v.2021 from uif01834 (Abraham Estrada):
    ...
    *Length bytes was modified for DID F093
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F093 SOH Wdg Monitor Status
    *****************************************************************************
    '''
    ...
    def test_003(self, name='Read SUM_SOH Watchdog Manager Reliability Monitor'):
        test.preconditions(
    ...
    def test_007(self, name='Read SUM_SOH Watchdog Manager Reliability Monitor'):
        test.preconditions(
    ...
    def test_010(self, name='Read SUM_SOH Watchdog Manager Reliability Monitor'):
        test.preconditions(
    ...
    def test_013(self, name='Read SUM_SOH Watchdog Manager Reliability Monitor'):
        test.preconditions(
    ...
    def test_016(self, name='Read SUM_SOH Watchdog Manager Reliability Monitor'):
        test.preconditions(
    ...
    def test_019(self, name='Read SUM_SOH Watchdog Manager Reliability Monitor'):
        test.preconditions(
