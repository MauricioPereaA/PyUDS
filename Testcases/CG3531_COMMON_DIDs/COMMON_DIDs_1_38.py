...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0FB File Updated State Indicator (FUSI)
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read File Updated State Indicator (FUSI)'):
    ...
    def test_005(self, name='Read File Updated State Indicator (FUSI)'):
    ...
    def test_011(self, name='Read File Updated State Indicator (FUSI), Installer'):
