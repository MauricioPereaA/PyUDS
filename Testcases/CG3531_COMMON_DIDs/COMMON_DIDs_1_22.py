...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0AB Compressed Vehicle Partitioning And Product Structure
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Compressed Vehicle Partitioning And Product Structure'):
    ...
    def test_005(self, name='Read Compressed Vehicle Partitioning And Product Structure'):
