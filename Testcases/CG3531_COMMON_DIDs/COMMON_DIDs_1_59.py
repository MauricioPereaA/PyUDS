...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F1E3 Ethernet Cable Diagnostic Test Results
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read ECU Wakeup Detection Records'):
        test.preconditions(
    ...
    def test_005(self, name='Read ECU Wakeup Detection Records'):
        test.preconditions(
