...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0F0 Programmed State Indicator
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Programmed State Indicator'):
    ...
    def test_009(self, name='Transition to programmingSession, Boot Mode'):
    ...
    def test_010(self, name='Read Programmed State Indicator'):
    ...
    def test_011(self, name='Transition Server to the defaultSession, Application Mode'):
