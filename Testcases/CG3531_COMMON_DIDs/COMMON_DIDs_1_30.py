...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0F2 Boot Initialization Status
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Boot Initialization Status'):
    ...
    def test_010(self, name='Read Boot Initialization Status'):
        if (device_under_test == 'MSM' or device_under_test == 'PTM' or device_under_test == 'ARB'):
            raise Warning('ECU does not support GB6005. Test step will skip.')
            pass
    ...
    def test_012(self, name='Read Boot Initialization Status'):
