...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0B3 Data Universal Numbering System Identification
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Data Universal Numbering System Identification'):
    ...
    def test_005(self, name='Read Data Universal Numbering System Identification'):
