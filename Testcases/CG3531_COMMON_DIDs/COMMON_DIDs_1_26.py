...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0CE Part of Assembly Part Number
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Part of Assembly Part Number'):
    ...
    def test_005(self, name='Read Part of Assembly Part Number'):
