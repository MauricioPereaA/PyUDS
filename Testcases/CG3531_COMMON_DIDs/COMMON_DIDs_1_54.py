...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F1DE GMECUCommunicationIdentificationData
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read GMECUCommunicationIdentificationData'):
        test.preconditions(
    ...
    def test_005(self, name='Read GMECUCommunicationIdentificationData'):
        test.preconditions(
