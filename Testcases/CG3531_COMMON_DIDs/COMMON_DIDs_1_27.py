...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *Deleted redundant Read tests before Verify tests
    *Added power mode OFF to test 14
    *Added test 19 (Transition to extendedSession, Application Mode)
    *MSM, ARB, PTM skip test. (Added import for device_under_test)
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0DF Vehicle Odometer
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Vehicle Odometer'):
    ...
    def test_003(self, name='Write Vehicle Odomoter'):
    ...
    def test_006(self, name='Read Vehicle Odometer'):
    ...
    def test_007(self, name='Write Vehicle Odometer'):
    ...
    def test_010(self, name='Read Vehicle Odometer'):
    ...
    def test_011(self, name='Write Vehicle Odometer'):
    ...
    def test_016(self, name='Read Vehicle Odometer'):
    ...
    def test_017(self, name='Write Vehicle Odometer'):
