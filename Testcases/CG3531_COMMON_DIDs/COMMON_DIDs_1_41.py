...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F181 Application Software Identification Data Identifier
    *****************************************************************************
    '''
    ...
    def test_003(self, name='Read Application Software Identification Data Identifier'):
    ...
    def test_007(self, name='Read Application Software Identification Data Identifier'):
    ...
    def test_012(self, name='Transition to programmingSession, Installer'):
    ...
    def test_013(self, name='Read Application Software Identification Data Identifier'):
        if (device_under_test == 'MSM' or device_under_test == 'PTM' or device_under_test == 'ARB'):
            raise Warning('ECU does not support GB6005. Test step will skip.')
            pass
    ...
    def test_015(self, name='Transition to programmingSession Boot Mode'):
    ...
    def test_017(self, name='Read Application Software Identification Data Identifier'):
    ...
    def test_018(self, name='Transition Server to the defaultSession, Application Mode'):
