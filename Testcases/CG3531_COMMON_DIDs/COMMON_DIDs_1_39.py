...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *MSM skips steps 3,4 and 8,9. (Added import for device_under_test)
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F129 Total Vehicle Operation Time
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Total Vehicle Operation Time'):
    ...
    def test_003(self, name='Write Total Vehicle Operation Time'):
    ...
    def test_007(self, name='Read Total Vehicle Operation Time'):
    ...
    def test_008(self, name='Write Total Vehicle Operation Time'):
        if (device_under_test == 'MSM'):
            pass
