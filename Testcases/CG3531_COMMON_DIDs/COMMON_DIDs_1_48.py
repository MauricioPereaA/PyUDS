...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F1B0 Diagnostic Address
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Diagnostic Address'):
        test.preconditions(
    ...
    def test_005(self, name='Read Diagnostic Address'):
        test.preconditions(
    ...
    def test_011(self, name='Read Diagnostic Address'):
        if device_under_test == 'MSM' or device_under_test == 'PTM' or device_under_test == 'ARB':
            raise Warning('ECU does not support GB6005. Test step will skip.')
            pass
        test.preconditions(
    ...
    def test_013(self, name='Read Diagnostic Address'):
        test.preconditions(
    ...
    def test_014(self, name='Transition to defaultSession, Application Mode'):
        test.preconditions(
