...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F1DB GM End Model Part Number Alpha Code
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read GM End Model Part Number Alpha Code'):
    ...
    def test_003(self, name='Write GM End Model Part Number Alpha Code'):
    ...
    def test_007(self, name='Read GM End Model Part Number Alpha Code'):
    ...
    def test_008(self, name='Write GM End Model Part Number Alpha Code'):
    ...
    def test_017(self, name='Read GM End Model Part Number Alpha Code'):
        if (device_under_test == 'MSM' or device_under_test == 'PTM' or device_under_test == 'ARB'):
            raise Warning('ECU does not support GB6005. Test step will skip.')
            pass
    ...
    def test_019(self, name='Read GM End Model Part Number Alpha Code'):
    ...
    def test_020(self, name='Write GM End Model Part Number Alpha Code'):
    ...
    def test_021(self, name='Transition Server to the defaultSession, Application Mode'):
