...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0F7 Controller And Software Description
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Controller And Software Description'):
    ...
    def test_005(self, name='Read Controller And Software Description'):
