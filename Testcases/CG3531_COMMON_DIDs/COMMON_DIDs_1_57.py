...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *CG has different DID. Original: F1E1. Current: F245.
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    ...
    *****************************************************************************
    ...
    def test_002(self, name='Read Device Limits Exceeded For IO Controls'):
        test.preconditions(
    ...
    def test_005(self, name='Read Device Limits Exceeded For IO Controls'):
        test.preconditions(
