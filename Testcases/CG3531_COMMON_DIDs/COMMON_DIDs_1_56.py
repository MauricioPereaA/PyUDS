...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *CG has different DID. Original: F1E0. Current: F1E6.
    *MSM skips entire test case.
    *Power Mode OFF for test 3
    *Additional tests 6 through 19 to match CG.
    *Access Security Request Seed 'dataLength':31 instead of None
    *MSM/PTM/ARB skip tests 10, 11 (Edit: MSM/PTM/ARB skip entire test.)
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    ...
    *****************************************************************************
    ...
    def test_002(self, name='Read Ethernet Bridge Part Number Check'):
    ...
    def test_005(self, name='Read Ethernet Bridge Part Number Check'):
    ...
    def test_011(self, name='Read Ethernet Bridge Part Number Check'):
    ...
    def test_013(self, name='Read Ethernet Bridge Part Number Check'):
    ...
    def test_015(self, name='Transition Server to the defaultSession, Boot Mode'):
