...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0F9 Installer Info Block Subject Name and ECU Name
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Installer Info Block Subject Name and ECU Name'):
    ...
    def test_005(self, name='Read Installer Info Block Subject Name and ECU Name'):
    ...
    def test_011(self, name='Read Installer Info Block Subject Name and ECU Name'):
