...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0B4 Manufacturing Traceability Characters
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Manufacturing Traceability Characters'):
    ...
    def test_005(self, name='Read Manufacturing Traceability Characters'):
