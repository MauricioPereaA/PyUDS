...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0F6 Boot Info Block Subject Name and ECU Name
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Boot Info Block Subject Name and ECU Name'):
    ...
    def test_005(self, name='Read Boot Info Block Subject Name and ECU Name'):
    ...
    def test_011(self, name='Read Boot Info Block Subject Name and ECU Name'):
    ...
    def test_012(self, name='Transition Server to the defaultSession, Application Mode'):
