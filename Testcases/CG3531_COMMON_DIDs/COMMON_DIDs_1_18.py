...
Changes for v.2021 from uif01834 (Abraham Estrada):
    ...
    *Length bytes was modified for DID F094
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F094 SUM SOH Port Interface Request Exceeded
    *****************************************************************************
    '''
    ...
    def test_003(self, name='Read SUM_ERRH Local Supervised WdgM Status of SUM_SOH'):
        test.preconditions(
    ...
    def test_007(self, name='Read SUM_ERRH Local Supervised WdgM Status of SUM_SOH'):
        test.preconditions(
    ...
    def test_010(self, name='Read SUM_ERRH Local Supervised WdgM Status of SUM_SOH'):
        test.preconditions(
    ...
    def test_013(self, name='Read SUM_ERRH Local Supervised WdgM Status of SUM_SOH'):
        test.preconditions(
    ...
    def test_016(self, name='Read SUM_ERRH Local Supervised WdgM Status of SUM_SOH'):
        test.preconditions(
    ...
    def test_019(self, name='Read SUM_ERRH Local Supervised WdgM Status of SUM_SOH'):
        test.preconditions(
