...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F08C Communication Channel Status CAN
    *****************************************************************************
    '''
    ...
    def test_002(self, name='Read Communication Channel Status CAN'):
    ...
    def test_005(self, name='Read Communication Channel Status CAN'):
