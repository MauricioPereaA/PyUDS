...
Changes for v.2019 from uic13313 (Gad, Yasmin):
    ...
    *MSM and ARB skip test (added import for device_under_test)
"""
...
class Test_CorpCommon_DIDs(unittest.TestCase):
    '''
    *****************************************************************************
    @test DID $F0CD Part of Assembly Traceability Characters
    *****************************************************************************
    '''
    ...
    def setUpClass(self):
        ...
        if (device_under_test == 'MSM' or device_under_test == 'ARB'):
            pass
    ...
    def test_002(self, name='Read Part of Assembly Traceability Characters'):
    ...
    def test_005(self, name='Read Part of Assembly Traceability Characters'):
