...
class RID_0200_0204_0205_0272(unittest.TestCase):
    ...
    def test_009(self, name='Start Routine ECU Key Provision Data'):
    ...
    def test_015(self, name='Start Routine ECU Key Provision Data'):
    ...
    def test_019(self, name='Start Routine ECU Key Provision Data'):
    ...
    def test_020(self, name='Transition to Default Diagnostic Session'):
